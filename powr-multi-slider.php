<?php
    ...
    Plugin URI: https://www.powr.io/plugins/multi-slider
    ...
    */
    ...
    function powr_multi_slider_options() {
      if(powr_local_mode()){//Determine JS url:
        $redirect_url = 'https://localhost:3000/wp-create/multi-slider';
      }else{
        $redirect_url = 'https://www.powr.io/wp-create/multi-slider';
      }
